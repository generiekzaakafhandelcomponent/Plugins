...
import com.ritense.valtimoplugins.huggingface.client.mistral.*
...
class MistralOCRModel(
    ...
    private fun post(path: String, mistralFileRequest: MistralFileRequest): String {
        try {
            ...
            return response.pages.toString()
        } catch (ex: Exception) {
            ex.printStackTrace()
