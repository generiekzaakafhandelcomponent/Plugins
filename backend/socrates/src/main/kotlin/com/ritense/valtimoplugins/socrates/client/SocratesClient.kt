...
class SocratesClient(
    ...
    fun dienstAanmaken(zaakId: String, loBehandeld: LoBehandeld, betrokkenenWrapper: BetrokkenenWrapper): LOBehandeldRespons {
        val requestBody = LOBehandeldRequest(
            identificatie = zaakId,
            loBehandeld = loBehandeld,
            betrokkenen = betrokkenenWrapper.betrokkenen
        )
