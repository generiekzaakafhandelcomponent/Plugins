...
class HuggingFaceAutoConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean(HuggingFaceClient::class)
    fun huggingFaceClient(
        restClientBuilder: RestClient.Builder,
    ): HuggingFaceClient {
        return HuggingFaceClient(restClientBuilder, null, null)
    }
    ...
    fun huggingFacePluginFactory(
        ...
        return HuggingFacePluginFactory(pluginService, huggingFaceClient)
    }
