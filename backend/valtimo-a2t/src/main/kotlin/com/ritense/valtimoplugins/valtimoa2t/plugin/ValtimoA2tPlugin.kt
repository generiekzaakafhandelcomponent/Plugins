...
package com.ritense.valtimoplugins.valtimoa2t.plugin
...
open class ValtimoA2tPlugin(
    ...
    @PluginAction(
        key = "audio-to-transcription",
        title = "Audio to Transcription",
        description = "Converts an audio file to text using Mistral Voxtral.",
        activityTypes = [ActivityTypeWithEventName.SERVICE_TASK_START]
    )
    open fun audioToTranscription(
        ...
        val transcription = mistralVoxtralModel.transcribeAudio(
