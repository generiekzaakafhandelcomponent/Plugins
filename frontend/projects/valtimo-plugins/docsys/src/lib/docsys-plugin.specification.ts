...
const DocsysPluginSpecification: PluginSpecification = {
  ...
  pluginTranslations: {
    nl: {
      ...
      url: 'Docsys URL',
      urlTooltip: 'Een URL naar de REST API van Docsys.',
      description: 'Publiceer berichten met de Docsys plugin.',
    ...
    en: {
      ...
      url: 'Docsys URL',
      urlTooltip: 'A URL to the REST API of Docsys',
      description: 'Post messages with the Docsys plugin.',
    ...
    de: {
      ...
      url: 'Docsys URL',
      urlTooltip: 'Die URL zur REST API von Docsys',
      description: 'Veröffentlichen Sie Nachrichten mit dem Docsys-Plugin.',
