...
const ollamaPluginSpecification: PluginSpecification = {
  ...
  pluginTranslations: {
    nl: {
      ...
      description: 'Verzend propmpts naar de Ollama plugin.',
      configurationTitle: 'Configuratienaam',
      configurationTitleTooltip:
        'De naam van de huidige plugin-configuratie. Onder deze naam kan de configuratie in de rest van de applicatie teruggevonden worden.',
      message: 'Bericht',
      messageTooltip: 'De berichttekst.',
      responseVariable: 'Proces variabele',
      responseVariableTooltip: 'Sla het antwoord op in een proces variabele.',
      smollm: 'smollm:135m',
      deepseek: 'deepseek-r1:1.5b',
      languageModel: 'Taal model',
      languageModelTooltip: 'Taal model om te gebruiken',
    },
    en: {
      title: 'Ollama',
      ...
      description: 'Send prompts to the Ollama plugin.',
      configurationTitle: 'Configuration name',
      configurationTitleTooltip:
        'The name of the current plugin configuration. Under this name, the configuration can be found in the rest of the application.',
      message: 'Message',
      messageTooltip: 'The message text.',
      responseVariable: 'Process variable',
      responseVariableTooltip: 'Save the response in a process variable.',
      smollm: 'smollm:135m',
      deepseek: 'deepseek-r1:1.5b',
      languageModel: 'Language model',
      languageModelTooltip: 'Language model to use',
    },
    de: {
      title: 'Ollama',
      ...
      responseVariable: 'Prozessvariable',
      responseVariableTooltip: 'Speichere die Antwort in einer Prozessvariable.',
      smollm: 'smollm:135m',
      deepseek: 'deepseek-r1:1.5b',
      languageModel: 'Sprachmodell',
      languageModelTooltip: 'Zu verwendendes Sprachmodell',
    },
  },
};
