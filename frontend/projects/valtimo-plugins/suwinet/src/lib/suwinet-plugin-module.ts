...
@NgModule({
    ...
    imports: [CommonModule, PluginTranslatePipeModule, FormModule, InputModule, FormsModule, PluginTranslatePipeModule, FormModule, FormModule, FormModule, FormModule, ParagraphModule, SelectModule, CarbonMultiInputModule],
    exports: [
        SuwinetPluginConfigurationComponent,
        BrpPersoonInfoComponent,
        BrpPartnerInfoComponent,
